...
def test_preorderTraversal():
    ...
    # Test 1: Empty tree
    root1 = None
    res1 = solver.preorderTraversal(root1)
    print("Test 1: Empty tree ->", res1)
    assert res1 == []

    # Test 2: Single node
    root2 = TreeNode(1)
    res2 = solver.preorderTraversal(root2)
    ...
    res3 = solver.preorderTraversal(root3)
    ...
    res4 = solver.preorderTraversal(root4)
    ...
    res5 = solver.preorderTraversal(root5)
    ...
    res6 = solver.preorderTraversal(root6)
    ...
    res7 = solver.preorderTraversal(root7)
    ...
    res8 = solver.preorderTraversal(root8)
    print("Test 8: Balanced tree ->", res8)
    assert res8 == [1, 2, 4, 5, 3]
    ...
    res9 = solver.preorderTraversal(root9)
    print("Test 9: Complex tree ->", res9)
    assert res9 == [1, 2, 4, 5, 3, 6, 7]
    ...
    res10 = solver.preorderTraversal(root10)
    print("Test 10: Tree with negative values ->", res10)
    assert res10 == [0, -1, -2, 1, 2]
